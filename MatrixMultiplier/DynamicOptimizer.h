...
public:
    ...
    long double sparse_optimal_matrix_chain_order_from_cache(string metapath, vector<int> dims, vector<TransitionMatrix*> matrices, unordered_map<string, NodeInfo*> cachedNodes, tuple<string, string, string> constraint, int _s, ST* stree);
